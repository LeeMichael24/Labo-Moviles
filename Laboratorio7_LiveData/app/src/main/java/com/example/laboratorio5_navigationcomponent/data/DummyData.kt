package com.example.laboratorio5_navigationcomponent.data.models
...
val name = "Batman: The Dark Knight"
    ...
    val cualification2 = "9.9"

    val movies = mutableListOf(
        MovieModel(name, category, description, cualification),
        MovieModel(name2, category2, description2, cualification2)
